...
//     res.status(200).json({
//         _id: req.seller._id,
//         isAdmin: req.seller.role === 0 ? false : true,
//         isAuth: true,
...
//         if (!seller)
//             return res.json({
//                 loginSuccesSeller: false,
//                 message: "Auth failed, email not found"
//             });

//         seller.comparePassword(req.body.password, (err, isMatch) => {
//             if (!isMatch)
//                 return res.json({ loginSuccesSeller: false, message: "Wrong password" });

//             seller.generateToken((err, seller) => {
//                 if (err) return res.status(400).send(err);
//                 res.cookie("w_authExp", seller.tokenExp);
//                 res
//                     .cookie("w_auth", seller.token)
//                     .status(200)
//                     .json({
//                         loginSuccesSeller: true, sellerId: seller._id
//                     });
//             });
//         });
//     });
